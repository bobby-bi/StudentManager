		...
		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="8">
				...
				<tr >
					<td >学生性别:</td>
					<td >
						<select id="add_sex"  class="easyui-combobox" style="width: 200px; "  name="sex" data-options="required:true,  missingMessage:'请选择所属性别'" >
		...
		<form id="editForm" method="post">
			...
			<table id="editTable2" cellpadding="8">
				...
				<tr >
					<td >学生性别:</td>
					<td >
						<select id="edit_sex"  class="easyui-combobox" style="width: 200px; "  name="sex" data-options="required:true,  missingMessage:'请选择所属性别'" >
							<option value="男">男</option>
							<option value="女">女</option>
						</select>
					</td>
