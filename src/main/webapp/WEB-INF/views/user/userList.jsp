   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		<tr >
	    			<td >用户名:</td>
	    			<td >
	    				<input id="add_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true,  missingMessage:'请填写用户名'" style="margin-bottom: 10px"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	    			<td ><input id="add_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="password" data-options="required:true, missingMessage:'请填写密码'" style="margin-bottom: 10px"/></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
